...
all_time = zeros(nG,Gt,Gs,nS,Ct,nA);
            ...
            for ns = 1:nS %number of samples
                ...
                for ct = 1:Ct %number of types of C
                    ...
                    for na = 1:nA %number of algorithms
                        ...
                        time_g(gt,gs,ns,ct,na) = toc(t1);
                        if strcmp(model,'GGSR-jiaxi-v1')
                            time_g(gt,gs,ns,ct,na) = out.t;                      
                        end
...
ylabel('Time (s)','FontSize',28,'FontWeight','bold','Interpreter','latex')
ax = gca;
ax.FontSize = 24;
grid on
